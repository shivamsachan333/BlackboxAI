...
console.log(error)
  ...
  console.log(Webiniars.Webiniar_name)
                      ...
                      <div className="container mx-auto cardsstart">
                          ...
                          <div className="flex flex-wrap Webiniarblocks" >
                              ...
                              <ul className="learnclass">
                                  ...
                                  <li> 1. {Webiniars.what_you_learn1}
                                  </li>
                                  <li>2. {Webiniars.what_you_learn2}</li>
                                  <li>


                                      3. {Webiniars.what_you_learn3}
                                  </li>


                                  <li>

                                      4. {Webiniars.what_you_learn4} </li>


                                  <li>
                                      5. {Webiniars.what_you_learn5}</li>


                              </ul>


                              <p>{Webiniars.what_you_learn_desc}</p>
                          </div>
                      </div>
                  </section>;
                  ...
                  <div className="container mx-auto cardsstart">
                      ...
                      <div className="flex flex-wrap Webiniarblocks" >
                          <div className="instructorprof flex flex-col items-center border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl ">
                              <Image width={100} height={100} className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src={Webiniars.Webiniar_image} alt="" />
                              <div className="flex flex-col justify-between p-4 leading-normal">
                                  <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{Webiniars.author_name}</h5>
                                  <p className="mb-3 font-normal text-gray-200 dark:text-gray-700">{Webiniars.about_author}</p>
                              </div>
                          </div>
                      </div>
                  </div>
...
const [successMessage, setSuccessMessage] = useState(null);
  const setFormDataField = (field, value) => {
      setFormData({
          ...formData,
          [field]: value,
          'Webinar_name' :Webiniars.Webiniar_name,
          'author_name':Webiniars.Author_name
      });
  };
  ...
  return (
      <>
          <Base>
              <div className="flex flex-wrap Webiniarblocks" >
                  <ServiceCard
                      title={Webiniars.Webiniar_name}
                      author_name={Webiniars.Author_name}
                      details={Webiniars.Webiniar_short_desc}
                      price={Webiniars.price}
                      Webiniar_date={Webiniars.Webiniar_date}
                      Webiniar_time={Webiniars.Webiniar_time}
                      icon={
                          <Image className="mx-auto" src={Webiniars.Webiniar_image} width="100" height="100" alt="Customizable Strategy Trading" />
              ...
              <section className="pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
                  ...
                  <div className="flex flex-wrap Webiniarblocks" >
                            <h3 className="text-white">
                                {Webiniars.Webiniar_name} by {Webiniars.Author_name}
                            </h3>
                            <p>
                                 {Webiniars.Webiniar_description_long}   </p>
