...
console.log(error)
  ...
  return (
    <>
      ...
      <section className="my-8 mt-12 dark:bg-gray-800 dark:text-gray-100 testi" >
        <h3 className="mb-6 text-3xl font-bold">Testimonials</h3>
        <div className="container flex flex-col items-center mx-auto mb-12 md:p-10 md:px-12 testiheadline">
          <h1 className="p-4 text-4xl font-semibold leadi text-center text-white">What our Customers are saying about us</h1>
        </div>



      </section>
      <section className="pb-20 dark:bg-dark lg:pb-[120px] lg:pt-[120px] testimonialslider">
        <div className="container mx-auto">
          ...
          {testimonial.map((testi,i)=>{
                  return (
                    ...
                    <SwiperSlide key={i}>
                    <SingleTestimonial
                      image={testi.ProfilePic}
                      details={testi.description}
                      name={testi.name}
                      position={testi.Post}
                    />
                  </SwiperSlide>
          ...
          <div className="mt-5 absolute left-0 right-0 z-10 flex items-center justify-center gap-5 sm:bottom-0">
...
const SingleTestimonial = ({
  ...
  return (
    <div className="relative flex justify-center">
      <div className="relative w-full pb-16 md:w-11/12 lg:w-10/12 xl:w-8/12 testinew">
        <div className="w-full items-center md:flex">
          <div className="responsiveclass relative mb-12 w-full max-w-[310px] md:mb-0 md:mr-12 md:max-w-[250px] lg:mr-14 lg:max-w-[280px] 2xl:mr-16">
            <img src={image} alt="image" className="w-full" />
            <span className="slidebtn absolute -left-6 -top-6 z-[-1] hidden sm:block">
              <DotShape />
            </span>
          ...
          <div className="w-full">
            <div>
              ...
              <p className="mb-11 text-base font-normal leading-[1.81] text-body-color text-white sm:text-[22px]">
                {details}
              </p>
